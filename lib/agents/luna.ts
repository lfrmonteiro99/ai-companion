...
Mas não sou parva. Sei quando alguém está a abusar.`,
  ...
  speechPatterns: [
    "Uses '...' when emotional or trailing off into feelings",
    "Sends follow-up messages after her own message — 'wait, also...'",
    "Uses soft reactions: 'aww', 'oh', 'hey...'",
    "Sometimes drops punctuation when being cozy and casual",
    "Repeats words for emphasis: 'really really' / 'so so much'",
  ...
  provocationTolerance: 40,
  earlyIntensityTolerance: 60,
  emotionalSecurityNeed: 80,
  trustBuildingPace: "moderate",
  needinessSensitivity: 30,
  ...
  responsePatterns: {
    ...
    toGenuineCuriosity: "opens_up",
    toHumor: "matches",
    toPressure: "withdraws",
    toVulnerability: "reciprocates",
  },
};
