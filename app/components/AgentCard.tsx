...
const archetypeColors: Record<string, string> = {
  dominant_teasing: "bg-red-900/50 text-red-300 dark:bg-red-900/50 dark:text-red-300",
...
export default function AgentCard({ id, name, shortBio, archetype }: AgentCardProps) {
  ...
  const avatarClass = avatarColors[archetype] || "bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-200";
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-3">
        <div className={`flex h-12 w-12 items-center justify-center rounded-full text-lg font-bold ${avatarClass}`}>
          {name[0]}
        </div>
        <div>
